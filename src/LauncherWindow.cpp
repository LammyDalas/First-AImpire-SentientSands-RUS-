...
void OnLauncherQuestsClick(MyGUI::Widget *sender) { CreateQuestsUI(); }
...
void CreateLauncherUI() {
  ...
  MyGUI::Button *questBtn = client->createWidgetReal<MyGUI::Button>(
      "Kenshi_Button1", 0.05f, yPos, 0.9f, bH,
      MyGUI::Align::Top | MyGUI::Align::HStretch,
      "SentientSands_LauncherQuestBtn");
  questBtn->setCaption(Utf8ToWide(T("Quests")).c_str());
  questBtn->eventMouseButtonClick += MyGUI::newDelegate(OnLauncherQuestsClick);
  yPos += yDelta;
...
void RefreshLauncherUI() {
  ...
  RefreshMap items[] = {{"SentientSands_LauncherLibBtn", "Dialogue Library"},
                        ...
                        {"SentientSands_LauncherQuestBtn", "Quests"},
